...
import { Icon, Card, Badge, Button, Avatar, Table, Input, Select, EmptyState } from "@/components/ui";
...
export default function EmployeeDirectory() {
  ...
  const filtered = employees.filter((e) => {
    ...
    const matchesQuery = !q || [e.name, e.role, e.dept, e.location, e.id].some((v) => v.toLowerCase().includes(q));
